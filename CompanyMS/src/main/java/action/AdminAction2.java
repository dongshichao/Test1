...
public class AdminAction2 extends ActionSupport implements SessionAware {
    ...
    public String delete() throws Exception{
        String hql ="delete Board where id=?1";
        Session hbnSession = HbnUtils.getSession();
        hbnSession.beginTransaction();
        hbnSession.createQuery(hql).setParameter(1,b.getId()).executeUpdate();
